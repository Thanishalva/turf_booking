jQuery(document).ready(function($) {
    ...
    function animateHeadline($headlines) {
        ...
        $headlines.each(function() {
            ...
            if (headline.hasClass('loading-bar')) {
                ...
                setTimeout(function() {
                    headline.find('.cs-words-wrapper').addClass('is-loading')
                }, barWaiting);
    ...
    function hideWord($word) {
        ...
        if ($word.parents('.cs-headline').hasClass('type')) {
            ...
            $word.parents('.cs-words-wrapper').animate({
                width: '2px'
            ...
            setTimeout(function() {
                $word.parents('.cs-words-wrapper').addClass('is-loading')
            }, barWaiting);
    ...
    function showLetter($letter, $word, $bool, $duration) {
        ...
        if (!$letter.is(':last-child')) {
            ...
            if ($word.parents('.cs-headline').hasClass('type')) {
                setTimeout(function() {
                    $word.parents('.cs-words-wrapper').addClass('waiting');
                }, 200);
            }
            if (!$bool) {
                setTimeout(function() {

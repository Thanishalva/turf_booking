    ...
    */
    ...
    function mainNav() {
        ...
        $(".menu-item-has-children").append(
            '<span class="cs-munu__dropdown__toggle"></span>'
        );
        $(".cs-munu__toggle").on("click", function() {
            $(this)
                .toggleClass("cs-toggle__active")
                .siblings(".cs-nav__list")
                .slideToggle();
        });
